...
class MongoDBClient:
    ...
    async def connect(self):
        ...
        if self.enable_cloud_sync and self.cloud_uri:
            try:
                ...
                logger.warning("Failed to connect to cloud MongoDB",
                               error=str(e))
    ...
    async def write_telemetry_data(
        ...
        if self.cloud_client:
            try:
                ...
                logger.warning("Failed to write to cloud database",
                               error=str(e))
    ...
    async def _add_to_failed_queue(
        ...
        try:
            failed_collection = self.local_client[
                self.local_db_name][f"failed_{data_type}"]
            failed_document = {
                **document,
    ...
    async def health_check(self) -> Dict[str, Any]:
        ...
        health = {
            ...
            "cloud": {"connected": False, "error": None,
