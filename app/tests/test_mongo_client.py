...
class TestMongoDBClient:
    ...
    async def test_write_telemetry_data_success(self, mongo_client):
        ...
        mock_local_client.__getitem__.return_value.__getitem__.return_value = mock_collection
    ...
    async def test_write_telemetry_data_with_cloud_sync(self, mongo_client):
        ...
        # Setup local client
        mock_local_client.__getitem__.return_value.__getitem__.return_value = mock_local_collection
        mock_local_collection.insert_one.return_value = mock_insert_result
        mock_local_collection.update_one = AsyncMock()
        
        # Setup cloud client
        mock_cloud_client.__getitem__.return_value.__getitem__.return_value = mock_cloud_collection
    ...
    async def test_health_check_local_unhealthy(self, mongo_client):
        ...
        mock_local_client = AsyncMock()
        mock_local_client.admin.command = AsyncMock(side_effect=Exception("Connection lost"))
